...
static int stitch_3d_init()
{
    ...
    ret = mBVStitch_2_0_Init(fbnum, szInter, szExter, szCarMatrixFile, szCarModelFile, 
	    src_w, src_h, SV_STITCH_X, SV_STITCH_Y, SV_STITCH_WIDTH, SV_STITCH_HEIGHT, radratio);
