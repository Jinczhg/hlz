 ...
 *  Author: xuhongchao
 *  Description: define the enumeration type
 */

#ifndef INTERFACE_VSOMEIP_ENUMERATION_TYPES_HPP_
#define INTERFACE_VSOMEIP_ENUMERATION_TYPES_HPP_
...
enum class conn_type_e: uint8_t {
	ST_CONNECTED = 0x0,
	ST_DISCONNECTED = 0x1
};
...
#endif /* INTERFACE_VSOMEIP_ENUMERATION_TYPES_HPP_ */
